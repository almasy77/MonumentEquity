        ...
        <div className="min-h-screen bg-slate-950 flex items-center justify-center px-4">
              <Card className="w-full max-w-sm bg-slate-900 border-slate-800">
                      <CardHeader className="text-center pb-4">
                                ...
                                <h1 className="text-xl font-bold text-white">Reset Password</h1>h1>
                      ...
                      <div className="text-center space-y-4">
                                    ...
                                    <p className="text-slate-300 text-sm">
                                                    If an account exists for <strong>{email}</strong>strong>, we sent a password reset link. Check your inbox and spam folder.
                                    </p>p>
                                    <Link href="/login">
                      ...
                      <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        {error && (
                                        <p className="text-red-400 text-sm text-center">{error}</p>p>
                                    )}
                                    <Button
                                                      type="submit"
                                                      disabled={loading}
