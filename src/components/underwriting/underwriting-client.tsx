  ...
  return (
    <div className="space-y-4">
      ...
      <AssumptionsForm
        ...
        dealTaxDefaults={{ millRate: deal.tax_mill_rate, millAssessedPct: deal.tax_mill_assessed_pct, assessmentPct: deal.tax_assessment_pct, marketValue: deal.tax_market_value, currentAnnualTax: deal.current_annual_taxes, abatementPresent: deal.tax_abatement_present, state: deal.state }}
        ...
        goingInCapRate={result.metrics?.going_in_cap}
      />
